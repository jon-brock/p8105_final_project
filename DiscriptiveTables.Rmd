...
In this table I calculated the median and interquartile range of how many days it took for cases to close.  Given the data is skewed right I reported the median values being `1` to `2` days and largest interqutile range being `0 - 9` and smallest being `0 - 6` acroos years `2014 - 2018`. 
