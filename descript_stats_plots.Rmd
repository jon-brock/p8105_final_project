...
nyc_plots %>%
    ...
    ggplot(aes(x = diff_dayt, y = median_income, group = diff_dayt)) + 
    geom_boxplot()
...
d %>% ggplot(aes(x = percent_pop, y = n, group = race, color = race)) +
    geom_line()
...
table of open, closed, proportion open, and total cases per each borough
