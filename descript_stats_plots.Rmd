...
Total complaints broken down by neighborhood and borough? --> Plots broken down by community district, incorporate proportions of race/population

proportion open cases across each income group faceted by borough
proportion open health cases across each income group faceted by borough

density plot of number of days to close by income group - ??
